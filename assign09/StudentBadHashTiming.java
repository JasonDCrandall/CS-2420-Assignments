...
/**
 * A timing class for StudentBadHash meant to time its
 * runtime for various methods when used in a HashTable
 * 
 * @author Jason Crandall & Michael Hart
 * @version March 28, 2019
 */
public class StudentBadHashTiming {
	
	private static HashTable<StudentBadHash, Integer> table = new HashTable<StudentBadHash, Integer>();
	...
	public static void main(String[] args) {
		...
		for (int n = 1000; n <= 20000; n += 1000) {
			...
			for (int i = 0; i < n; i++) {
				...
				StudentBadHash student = new StudentBadHash(rng.nextInt(100000) + 999999, first, last);
				table.put(student, 0);
				first = new String();
				last = new String();
			}
